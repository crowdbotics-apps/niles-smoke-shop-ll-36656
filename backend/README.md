...
## Project Structure
    ...
    ├── niles_smoke_shop_ll_36656  # Django project configurations
...
1. Clone this repo and `cd niles_smoke_shop_ll_36656`
...
2. Clone this repo and `cd niles_smoke_shop_ll_36656`
